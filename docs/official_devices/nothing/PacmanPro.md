---
slug: /devices/PacmanPro
pagination_next: null
pagination_prev: null
title: "Phone (2a) Plus (PacmanPro)"
---
...
<a href="https://get.hlcyn.org/builds/PacmanPro/" class="button button--primary">Get builds</a>
...
6. Sideload the ROM:
```
adb sideload ota-halcyon_PacmanPro-xxxxx.zip
```
